...
tf.app.flags.DEFINE_string('out_dir', '/home/kal/TF_models/seq_only/seq_classifier/', 'Location to write output files.')
...
def main(argv=None):
    ...
    # Activate with sigmoid, not tanh!
    ...
    CTCFgen = seq_only_gen.CTCFGenerator(gen_path)
    traingen = CTCFgen.pair_gen(mode='train')
    valgen = CTCFgen.pair_gen(mode='val')
    ...
    num_batches = CTCFgen.get_num_training_examples() // batch_size
