...
class BasicConv(object):
    ...
    def __init__(self, num_inputs, conv_list, num_outputs=1, drop_rate=0.0, final_activation='relu'):
...
if __name__ == '__main__':
    tf.app.run()
    network = ConvNet(4, FLAGS.conv_list, drop_rate=FLAGS.drop_rate)
    input = Input(shape=(2*FLAGS.input_window, 4))
